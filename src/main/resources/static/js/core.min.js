...
function cloud_animate(a, b) {
    $("#" + a).animate({marginLeft: parseInt($("#" + a).css("marginLeft")) + 30 * b}, cloud_time, function () {
        cloud_animate(a, -b)
    })
}
...
$(function () {
    $("#email,#password").blur(function () {
    ...
    }), cloud_animate("cloud_s", -1), cloud_animate("cloud_m", 1), $(".job_company h2 img").hover(function () {
        ...
        $("#box_expectCity").hide(), $("#workplaceSelect .more").removeClass("open").children(".citymore_arrow").removeClass("transform")
    }), $("#workplaceSelect .more").click(function (a) {
        a.stopPropagation(), $(this).hasClass("open") ? ($(this).removeClass("open"), $(this).children(".citymore_arrow").removeClass("transform"), $(this).siblings("#box_expectCity").hide()) : ($(this).addClass("open"), $(this).children(".citymore_arrow").addClass("transform"), $(this).siblings("#box_expectCity").show())
    })
});
var cloud_time = 2e3;
$(function () {
